...
export interface DummyUSDTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface DummyUSDT extends BaseContract {
  connect(runner?: ContractRunner | null): DummyUSDT;
  waitForDeployment(): Promise<this>;

  interface: DummyUSDTInterface;
